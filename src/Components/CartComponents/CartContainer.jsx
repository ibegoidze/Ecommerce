...
function Cart() {
  ...
  return (
    <div className="CCvapshemaini">
      <div className="CCmain">
        {cartItems.length === 0 ? (
          <div className="CCnoProductsInCart">
            <h1 className="CCnoProducts">No products in cart </h1>
          ...
          <div className="CC-PriceBox">
            <div className="CCcontainer">
              <ul className="CCbox">
                ...
                {cartItems.map((item) => (
                  <li key={Math.random()}>
                    ...
                    <div className="CCpriceDescription">
                      ...
                      <div className="CCprice">${Math.floor(item.price)}</div>
                      ...
                      <div>
                        <div className="CCquantity">
                          Quantity:
                          <button className="CCquantityButtons">-</button>{" "}
                          {item.quantity > 0 ? item.quantity : 1}
                          <button className="CCquantityButtons">+</button>{" "}
                          Total: ${item.price}
                        </div>
                        <button
                          className="CCremoveButton"
                ...
                <div className="CCbottomButtons">
                  <button onClick={() => navigate("/Listview")}>
                    Go back to shop
                  </button>
                  <button onClick={handleClearCart} className="CCremoveButton">
                    Remove all products
                  </button>
                </div>
              </ul>
