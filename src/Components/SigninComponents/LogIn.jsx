...
const LogIn = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://digitalamazonproject.azurewebsites.net/api/User/LogIn",
        {
          method: "POST",
          headers: {
  ...
  return (
    <div>
      <h2>Login</h2>
      <form onSubmit={handleLogin} className="SIlogincontainer">
        ...
        <div className="SIorcontinue"> or continue with</div>
        <div className="SIsvg"> 
          <svg
